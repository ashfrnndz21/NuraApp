...
LINES: Mapping[str, Mapping[str, tuple[str, ...]]] = {
    "en": {
        ...
        "commitment_said": ("You said this at your visit:",),
    ...
    "ms": {
        ...
        "commitment_said": ("Anda kata ini semasa lawatan anda:",),
...
WHY: Mapping[str, Mapping[str, str]] = {
    "en": {
        ...
        "commitment": "You see this because you said it at your visit.",
    ...
    "ms": {
        ...
        "commitment": "Anda nampak ini kerana anda kata begitu semasa lawatan.",
