...
HEADLINES: Mapping[str, Mapping[str, str]] = {
    ...
    "ms": {
        ...
        "logistics_today": "Ke {doctor} hari ini",
        "logistics_tomorrow": "Ke {doctor} esok",
    ...
    "zh": {
        ...
        "reading": "您今天的血压",
        "visit": "{day}见{doctor}",
        "logistics_today": "今天去见{doctor}",
        "logistics_tomorrow": "明天去见{doctor}",
        "memo": "{doctor}说的话",
...
WHY: Mapping[str, Mapping[str, str]] = {
    ...
    "zh": {
        ...
        "visit_logistics": "您{day}要见{doctor}。",
