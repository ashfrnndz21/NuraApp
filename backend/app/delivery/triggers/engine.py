...
does; then the ladders of untapped tablets; then the morning card, the reorder, the pattern,
and the events; then the close of his day (`day`: the check-in and the family notice), after
the nudges so a check-in the day's nudge already asked is not asked again.
