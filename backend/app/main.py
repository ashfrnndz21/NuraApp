...
the fixture one (`NURA_DRUG_REGISTRY=fixture`) until a licensed client exists (E04); the WhatsApp
provider is the fixture (`NURA_WHATSAPP_PROVIDER=fixture`, signing with
