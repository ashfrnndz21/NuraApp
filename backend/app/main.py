...
summariser is the fixture one over NURA_VISIT_FIXTURES until a model in the region does
(E05). Logging is set up so that, on a dev run, the code line is seen.
"""
