...
class Settings:
    ...
    (NURA_DEMO_MODE=1) because Anthropic's first-party API does not process in SG or MY
    (ADR 0008) — a laptop dev run stays on the fixture. A name this build does not have
    refuses to start."""
