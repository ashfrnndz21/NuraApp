...
Follows E05's visit-loop revision (0012_visits), main's head when this story merged main back; the operator repoints `down_revision` if another story lands first.
