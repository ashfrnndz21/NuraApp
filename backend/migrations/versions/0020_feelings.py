...
Follows E02's capture revision (0018_capture_extras), main's head when this story was built;
the operator repoints `down_revision` if another story lands first.
