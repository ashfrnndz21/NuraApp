...
The first family's redacted papers, as the extraction sessions read them: the lab report and the medicine label (E02-01), a clinic slip and a prescription written by hand (E02-02), a hospital letter and a receipt as PDFs (E02-03), and the screens of a blood pressure machine and a glucometer (E02-08).
