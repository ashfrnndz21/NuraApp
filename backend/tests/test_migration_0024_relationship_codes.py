"""Revision 0024 names every stewardship's relationship by its code (#137's review)."""
...
async def test_0024_maps_the_phrases_it_knows_and_the_rest_to_other() -> None:
    migration = _load(VERSIONS / "0024_relationship_codes.py")
