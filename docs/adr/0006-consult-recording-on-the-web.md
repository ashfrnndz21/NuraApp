...
- Who can hear a recording is whoever holds the visits scope (ADR 0004): the family he let in, and a clinic key while it lasts. The person who records needs the records scope as well, because every artefact is kept through that door (`store_artifact`, `may_record`). The printed card says only he and his family can hear it; a clinic key can too. Whether the card must say so is a question for counsel (recording-consent.md §5–6).
