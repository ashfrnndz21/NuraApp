...
- **The chief's Home** (spec §1): in Mei's window, Today in the smaller look has **Watching for Pa** — "Explainers about blood pressure", "Explainers about amlodipine" once a tablet is on his list, each with its sources and how often — and **Sent to Pa this week**, each card with what became of it ("Pa opened this card.", "Pa heard this card.", "Nura kept this back from Pa."), where it came from, *Hear*, and *Pause this watch* on a card a watch found. *Watch for something new* → *Festive food*: "Festive food, before it comes" is on the list, weekly. Ramadan is not among her choices: whether he fasts is his to say. *Pause* on a watch: it says *Paused*, and *Start again* undoes it. No count of anything anywhere.
- **The ask bar's filters**: *Ask or search* on Today. In Mei's smaller look it has *Records*, *Web*, *Providers* and *Videos*. *Web*, "blood pressure", *Search*: pages from HealthHub and the National Heart Centre only, each said in plain words with the boundary last and "Read the page on HealthHub"; *Videos*: the heart centre's video only; *Providers*, "tan": Dr Tan from his own list. In Pa's look there is one thing: his records.
