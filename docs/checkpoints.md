...
- **His town** (E09-07): Pa's *Me* → *Where you live* ("The family member who looks after your papers can see your town.") → *Choose your town* → *Bedok* → "Do you live in Bedok?" → *Yes, I live there*: "Nura knows your town is Bedok." Mei reads it at `GET /profiles/{id}/area` and is refused setting it ("Only the owner of these papers can choose the town.").
