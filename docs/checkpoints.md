...
make checkpoint N=13    # Mei, with the lasting power of attorney Pa's papers were set up on
...
**As Mei from checkpoint 13.** *Papers for the family*: *Lasting power of attorney*, *Nura kept this on Tuesday 1 September.*, *An agreement to share rests on it.*, *Looking after these papers rests on it.* Adding it again (*Lasting power of attorney* → the PDF) keeps one paper: the same one, now with its bytes.
...
✓ record-papers.spec.ts    › the family's papers (patient|caregiver): the lasting power of attorney kept and shown backing the stewardship
23 passed
```
