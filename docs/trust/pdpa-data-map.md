...
<!-- data-map:begin -->
49 tables, 542 columns: 115 identifier, 220 health, 28 consent, 12 audit, 167 operational. Generated by `python3 -m scripts.data_map`; do not edit by hand.
...
| `delivery_settings` | `breakfast_at` | Time | yes | operational |
