...
<!-- data-map:begin -->
76 tables, 883 columns: 169 identifier, 404 health, 44 consent, 12 audit, 254 operational. Generated by `python3 -m scripts.data_map`; do not edit by hand.
...
| `consult_upload` | `opened_at` | DateTime | no | operational |
...
| `consult_upload` | `finished_at` | DateTime | yes | operational |
