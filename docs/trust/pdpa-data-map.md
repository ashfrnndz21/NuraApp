...
<!-- data-map:begin -->
90 tables, 1070 columns: 229 identifier, 437 health, 58 consent, 24 audit, 322 operational. Generated by `python3 -m scripts.data_map`; do not edit by hand.
...
| `seq_counters` | `name` | String | no | operational |
| `seq_counters` | `value` | BigInteger | no | operational |
...
| `login_challenge` | `seq` | BigInteger | no | operational |
...
| `profile` | `area` | String | yes | identifier |
...
| `conversation` | `id` | Uuid | no | health |
| `conversation` | `person_id` | Uuid | no | identifier |
| `conversation` | `started_at` | DateTime | no | operational |
| `conversation` | `last_turn_at` | DateTime | no | operational |
| `conversation` | `closed_at` | DateTime | yes | operational |
| `conversation` | `turn_count` | Integer | no | operational |
| `conversation` | `summarized_through` | Integer | no | operational |
| `conversation` | `summary` | String | yes | health |
| `conversation` | `seq` | BigInteger | no | operational |
| `conversation` | `profile_id` | Uuid | no | identifier |
| `conversation` | `written_scope` | Enum | no | consent |
...
| `delivery_settings` | `seq` | BigInteger | no | operational |
...
| `feed_page` | `seq` | BigInteger | no | operational |
...
| `last_looked` | `seq` | BigInteger | no | operational |
...
| `provider` | `category` | Enum | yes | health |
...
| `scheduled_call` | `id` | Uuid | no | identifier |
| `scheduled_call` | `with_person_id` | Uuid | no | identifier |
| `scheduled_call` | `scheduled_at` | DateTime | no | operational |
| `scheduled_call` | `call_link` | String | yes | operational |
| `scheduled_call` | `label` | String | yes | operational |
| `scheduled_call` | `added_by_person_id` | Uuid | no | identifier |
| `scheduled_call` | `added_at` | DateTime | no | operational |
| `scheduled_call` | `cancelled_at` | DateTime | yes | operational |
| `scheduled_call` | `profile_id` | Uuid | no | identifier |
...
| `consent` | `role` | Enum | yes | consent |
| `consent` | `window` | Enum | yes | consent |
...
| `consent` | `seq` | BigInteger | no | operational |
...
| `event` | `seq` | BigInteger | no | operational |
| `event` | `profile_id` | Uuid | no | identifier |
| `event` | `written_scope` | Enum | no | consent |
| `insight_report` | `id` | Uuid | no | health |
| `insight_report` | `generated_at` | DateTime | no | operational |
| `insight_report` | `week_of` | Date | no | operational |
| `insight_report` | `language` | String | no | operational |
| `insight_report` | `source` | String | no | operational |
| `insight_report` | `boundary` | JSON | no | health |
| `insight_report` | `sections` | JSON | no | health |
| `insight_report` | `seq` | BigInteger | no | operational |
| `insight_report` | `artifact_id` | Uuid | yes | identifier |
| `insight_report` | `headline` | String | yes | health |
| `insight_report` | `looked_at` | JSON | yes | health |
| `insight_report` | `profile_id` | Uuid | no | identifier |
...
| `review_card` | `pending_question` | Enum | yes | operational |
| `review_card` | `question_payload` | JSON | yes | health |
| `review_card` | `question_answer` | String | yes | operational |
| `review_card` | `question_answered_at` | DateTime | yes | operational |
| `review_card` | `question_answered_by_person_id` | Uuid | yes | identifier |
| `review_card` | `discarded_at` | DateTime | yes | operational |
| `review_card` | `profile_id` | Uuid | no | identifier |
| `turn` | `id` | Uuid | no | health |
| `turn` | `conversation_id` | Uuid | no | health |
| `turn` | `person_id` | Uuid | no | identifier |
| `turn` | `mode` | Enum | no | operational |
| `turn` | `language` | String | no | operational |
| `turn` | `question_artifact_id` | Uuid | no | health |
| `turn` | `answer_artifact_id` | Uuid | yes | health |
| `turn` | `answered` | Boolean | no | operational |
| `turn` | `line_count` | Integer | no | operational |
| `turn` | `created_at` | DateTime | no | operational |
| `turn` | `seq` | BigInteger | no | operational |
| `turn` | `profile_id` | Uuid | no | identifier |
| `turn` | `written_scope` | Enum | no | consent |
...
| `whatsapp_dose_question` | `seq` | BigInteger | no | operational |
...
| `policy` | `id` | Uuid | no | identifier |
| `policy` | `insurer_name` | String | no | identifier |
| `policy` | `policy_reference` | String | yes | identifier |
| `policy` | `policy_type` | Enum | no | identifier |
| `policy` | `covered` | String | yes | identifier |
| `policy` | `covers` | String | yes | identifier |
| `policy` | `start_date` | Date | yes | identifier |
| `policy` | `renewal_date` | Date | yes | identifier |
| `policy` | `premium_due_date` | Date | yes | identifier |
| `policy` | `status` | Enum | no | identifier |
| `policy` | `guarantee_letter` | Boolean | no | identifier |
| `policy` | `supersedes_id` | Uuid | yes | identifier |
| `policy` | `superseded_at` | DateTime | yes | operational |
| `policy` | `set_by_person_id` | Uuid | no | identifier |
| `policy` | `confirmation_id` | Uuid | no | consent |
| `policy` | `set_at` | DateTime | no | operational |
| `policy` | `plan` | String | yes | identifier |
| `policy` | `coverage_items` | JSON | yes | identifier |
| `policy` | `excludes` | JSON | yes | identifier |
| `policy` | `benefits` | JSON | yes | identifier |
| `policy` | `claim_steps` | JSON | yes | identifier |
| `policy` | `ends_on` | Date | yes | identifier |
| `policy` | `waiting_period` | String | yes | identifier |
| `policy` | `claims_contact` | String | yes | identifier |
| `policy` | `review_card_id` | Uuid | yes | identifier |
| `policy` | `essentials_cut` | JSON | yes | operational |
| `policy` | `profile_id` | Uuid | no | identifier |
| `profile_settings` | `id` | Uuid | no | health |
| `profile_settings` | `conditions` | JSON | no | health |
| `profile_settings` | `answers` | JSON | no | health |
...
| `consult_upload` | `id` | Uuid | no | health |
| `consult_upload` | `appointment_id` | Uuid | no | health |
| `consult_upload` | `consent_id` | Uuid | no | consent |
| `consult_upload` | `started_by_person_id` | Uuid | no | identifier |
| `consult_upload` | `content_type` | String | no | operational |
| `consult_upload` | `started_at` | DateTime | no | health |
| `consult_upload` | `opened_at` | DateTime | no | health |
| `consult_upload` | `chunks` | Integer | no | operational |
| `consult_upload` | `received_bytes` | Integer | no | operational |
| `consult_upload` | `doctor_said_yes_at` | DateTime | yes | consent |
| `consult_upload` | `discarded_at` | DateTime | yes | consent |
| `consult_upload` | `discarded_because` | String | yes | consent |
| `consult_upload` | `finished_at` | DateTime | yes | health |
| `consult_upload` | `recording_id` | Uuid | yes | health |
| `consult_upload` | `profile_id` | Uuid | no | identifier |
| `insurance_claim` | `id` | Uuid | no | identifier |
| `insurance_claim` | `policy_id` | Uuid | no | identifier |
| `insurance_claim` | `appointment_id` | Uuid | no | identifier |
| `insurance_claim` | `claim_reference` | String | yes | identifier |
| `insurance_claim` | `status` | Enum | no | identifier |
| `insurance_claim` | `claimed_amount_cents` | Integer | yes | health |
| `insurance_claim` | `paid_by_insurer_cents` | Integer | yes | health |
| `insurance_claim` | `paid_by_patient_cents` | Integer | yes | health |
| `insurance_claim` | `filed_by_person_id` | Uuid | no | identifier |
| `insurance_claim` | `confirmation_id` | Uuid | no | consent |
| `insurance_claim` | `filed_at` | DateTime | no | operational |
| `insurance_claim` | `status_changed_by_person_id` | Uuid | yes | identifier |
| `insurance_claim` | `status_changed_confirmation_id` | Uuid | yes | consent |
| `insurance_claim` | `status_changed_at` | DateTime | yes | operational |
| `insurance_claim` | `profile_id` | Uuid | no | identifier |
...
| `medication_line` | `product_kind` | Enum | yes | health |
| `medication_line` | `category` | String | yes | health |
| `medication_line` | `registry_confidence` | Float | yes | operational |
...
| `review_field` | `range` | JSON | yes | health |
| `review_field` | `label_on_paper` | String | yes | health |
...
| `conclusion_review` | `id` | Uuid | no | audit |
| `conclusion_review` | `profile_id` | Uuid | no | identifier |
| `conclusion_review` | `audit_entry_id` | Uuid | no | audit |
| `conclusion_review` | `response_kind` | Enum | no | audit |
| `conclusion_review` | `reason_code` | Enum | yes | audit |
| `conclusion_review` | `rule_id` | Integer | yes | audit |
| `conclusion_review` | `resulting_state_id` | Uuid | yes | audit |
| `conclusion_review` | `at` | DateTime | no | audit |
...
| `dose_taken` | `late` | Boolean | no | health |
...
| `feed_item` | `private_to` | Uuid | yes | identifier |
...
| `feeling_tap` | `seq` | BigInteger | no | operational |
...
| `interaction_flag` | `source` | String | no | health |
| `interaction_flag` | `awaiting_review` | Boolean | no | operational |
...
| `question` | `written_scope` | Enum | no | consent |
...
| `whatsapp_message` | `asks_feeling` | Boolean | no | operational |
...
| `feed_engagement` | `seconds` | Float | yes | health |
| `feed_engagement` | `client_id` | Uuid | yes | operational |
...
| `feeling_note` | `said` | String | no | health |
...
| `feeling_note` | `seq` | BigInteger | no | operational |
...
| `thread_message` | `seq` | BigInteger | no | operational |
...
| Search provider (the feed's watches; the ask bar's Web and Videos) | The words of the search — a condition or a medicine name for a watch, and what the user typed in the ask bar — with the allowlisted domains to search. Never his area, his name or any identifier (`tests/test_feed_formats.py`, the spy on what the searcher received) | The port is `app.delivery.feed.compress.Searcher`; only `FixtureSearcher` exists today, so nothing leaves yet. A real adapter must be region-pinned and must not retain the query |
