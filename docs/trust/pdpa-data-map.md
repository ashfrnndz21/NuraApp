...
<!-- data-map:begin -->
39 tables, 419 columns: 89 identifier, 168 health, 27 consent, 12 audit, 123 operational. Generated by `python3 -m scripts.data_map`; do not edit by hand.
...
| `flag` | `id` | Uuid | no | health |
| `flag` | `kind` | Enum | no | health |
| `flag` | `code` | String | no | health |
| `flag` | `posture` | Enum | no | health |
| `flag` | `artifact_id` | Uuid | yes | health |
| `flag` | `raised_at` | DateTime | no | health |
| `flag` | `raised_by_person_id` | Uuid | no | identifier |
| `flag` | `suppressed` | JSON | no | health |
| `flag` | `profile_id` | Uuid | no | identifier |
