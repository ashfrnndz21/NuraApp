...
| `review_item` | `lines` | JSON | no | operational |
...
| `review_item` | `reason` | String | yes | operational |
| `review_item` | `proposed` | JSON | yes | operational |
...
| `audit_entry` | `actor_person_id` | Uuid | no | identifier |
