...
| `content_item` | `id` | Uuid | no | operational |
| `content_item` | `content_type` | Enum | no | operational |
| `content_item` | `region` | Enum | no | operational |
| `content_item` | `language` | String | no | operational |
| `content_item` | `slug` | String | no | operational |
| `content_item` | `category` | String | yes | operational |
| `content_item` | `title` | String | no | operational |
| `content_item` | `summary` | String | no | operational |
| `content_item` | `body` | JSON | no | operational |
| `content_item` | `meta` | JSON | no | operational |
| `content_item` | `review_status` | Enum | no | operational |
| `content_item` | `review_item_id` | Uuid | yes | operational |
| `content_item` | `created_at` | DateTime | no | operational |
