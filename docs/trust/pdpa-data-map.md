...
<!-- data-map:begin -->
82 tables, 948 columns: 187 identifier, 417 health, 51 consent, 16 audit, 277 operational. Generated by `python3 -m scripts.data_map`; do not edit by hand.
...
| `delivery_settings` | `for_person_id` | Uuid | yes | identifier |
...
| `episode` | `body_systems` | JSON | no | health |
...
| `key` | `successor_waived_at` | DateTime | yes | consent |
| `key` | `successor_waived_by_person_id` | Uuid | yes | identifier |
