...
| `red_flag` | `feeling` | Enum | no | health |
| `red_flag` | `event_id` | Uuid | no | health |
...
| Named | *to be named by the owner before checkpoint 12* |
