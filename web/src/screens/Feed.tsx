...
function FeedCard({ entry, index, view, clips, player, playing, note, status, patient, owner, name, s, onHear, onAsk, onFamily, onNotForMe, onKeepGoing, reorder, said, onAskToOrder }: FeedCardProps): JSX.Element {
