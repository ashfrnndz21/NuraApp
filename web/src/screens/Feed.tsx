...
import type { FeedItemOut, LineOut } from "../api/types";
import { go } from "../flow";
...
function FeedCard({ entry, index, view, note, status, patient, owner, name, s, onHear, onAsk, onFamily, onNotForMe, onKeepGoing, reorder, said, onAskToOrder }: FeedCardProps): JSX.Element {
