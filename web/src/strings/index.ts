...
const ABOUT_HIM = {
  ...
  record: ["medicines", "papers", "routine", "timeline", "trends", "providers", "back", "papersNone", "storyAsk", "twice", "outcomeNew", "outcomeRefill", "flaggedNone", "added", "noteSaved", "sureYes", "notSet", "setDay", "dayAsk", "ledger", "ledgerWithheld", "ledgerPatientPaidLabel", "addedConnection"],
  reading: ["title"],
  visit: ["open"],
  me: ["whatNuraUsesLead"],
