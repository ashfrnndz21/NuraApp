...
export const ms = {
  ...
  record: {
    ...
    // @patient headline
    documents: "Surat untuk keluarga",
    // @patient headline
    ...
    // @patient
    documentsLead: "Simpan surat kuasa wakil kekal atau surat doktor di sini.",
    // @patient phrase
    tags: {
      lpa: "Surat kuasa wakil kekal",
      medical_letter: "Surat doktor",
      consent_form: "Borang persetujuan yang ditandatangani",
    },
    // @patient
    noDocuments: "Nura belum simpan surat seperti ini.",
    // @patient
    keptOn: "Nura simpan ini pada {date}.",
    // @patient
    backsConsent: "Satu persetujuan untuk berkongsi bergantung padanya.",
    // @patient
    backsStewardship: "Menjaga surat ini bergantung padanya.",
    // @patient
    chooseKind: "Surat jenis apa ini?",
    // @patient
    documentAdded: "Nura sudah simpan surat itu.",
  },
  errors: {
    // @patient
